...
<head>
    <title>HairCare-Thank You</title>
...
<body>
    <?php include_once('includess/header.php'); ?>

    <section class="hero-wrap hero-wrap-2" style="background-image: url('images/thankyou.jpg');" data-stellar-background-ratio="0.5">
    ...
    <?php include_once('includess/footer.php'); ?>
