                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="customer_list.php" class="small-box-footer">More info
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-primary">
                             ...
                             join tblservices  on tblservices.ID=tblinvoice.ServiceId");
                                ...
                                ?>
                                <div class="inner">
                                    <h3 id="totalsale"><?php echo number_format($totalsale, 2); ?></h3>
                                    <!-- <input type="hidden" id="totalsale" value="<?php ?>"> -->
