						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<input type="name" name="name" class="form-control" placeholder="Name" disabled>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" name="phone" class="form-control" placeholder="Phone" disabled>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<div class="input-wrap">
										...
										<input type="text" name="adate" class="form-control book_date" placeholder="Date" disabled>
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<div class="input-wrap">
										...
										<input type="text" name="atime" class="form-control book_time" placeholder="Time" disabled>
									</div>
								</div>
							</div>
							<div class="col-md-4">
									...
									<div class="form-field">
										<div class="select-wrap">
											...
											<select name="services" id="services" class="form-control" disabled>
												...
												?>
												<option style="color: red;" value="<?php //echo $row['ServiceName']; 
							...
							<div class="col-md-2">
								<div class="form-group">
									<input type="submit" name="submit" value="Book Now" class="btn btn-white " disabled>
								</div>
							</div>
						</div>
					</form>
