...
if (isset($_POST['submit'])) {
  ...
  $eid = $_SESSION['edid'];
  $query = mysqli_query($con, "update  tblservices set StaffName='$StaffName',ServiceName='$sername',Cost='$cost' where ID='$eid' ");
  if ($query) {
  ...
  ?>
    <div class="card-body">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="StaffName" name="StaffName" placeholder="Service Name" value="<?php echo $row['StaffName']; ?>" required="true">
      </div>
      <div class="form-group">
