      ...
      <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">View User Profile</h6>
          </div>
          <div class="card-body">
            <form method="post">
              <?php
                ...
                <div class="row">
                  <div class="col-md-4 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                      <img src="../user/user_images/<?php echo $row['userimage']; ?>" width="100%" height="100%">
                      <span class="font-weight-bold"><?php echo $row['name']; ?><br> <?php echo $row['sex']; ?></span>
                  ...
                  <div class="col-md-8">
                    <div class="p-3 py-5">
                      ...
                      <div class="row mt-3">
                        ...
                        <div class="col-md-6"><input type="text" class="form-control" value="0<?php echo $row['mobile']; ?>" name="mobile" required>
                        </div>
                      </div>
