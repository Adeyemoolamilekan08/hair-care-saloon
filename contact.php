...
if (isset($_POST['submit'])) {
  ...
  if (!$result) {
    header("contact.php");
    $msg =  "Sorry we could not send your message";
  } else {
  ...
  <section class="ftco-section contact-section bg-light">
    <div class="container">
      <div class="row d-flex contact-info">
        ...
        <div class="col-md-3 d-flex">
          <div class="dbox">
            <p><span>Phone:</span> <a href="tel://1234567920">09133808000</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="dbox">
            <p><span>Email:</span> <a href="mailto:info@.com">adeyemoolamilekan08@gmail.com</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="dbox">
            <p><span>Website:</span> <a href="https://facebook.com">Gigstech.com</a></p>
          </div>
        </div>
      </div>
    </div>
