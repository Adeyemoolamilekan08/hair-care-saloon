  ...
  <!-- <form class="form-inline ml-3">
    <div class="input-group input-group-sm">
      ...
      <div class="input-group-append">
        <button class="btn btn-navbar" type="submit" name="save">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        ?>
            <!--a href="view-appointment.php?viewid=<?php ////echo $result['ID'];
                                                    ?>" class="dropdown-item">
          ...
          <a class="dropdown-item" href="  new_appointment.php">No New Appointment Received</a>
        <?php
        } ?>


        <div class="dropdown-divider"></div>
        <a href="all_appointments.php" class="dropdown-item dropdown-footer">See All Appointment</a>
      </div>
    </li>
    <li class="nav-item">
